...
-- Copiando estrutura do banco de dados para cidades
DROP DATABASE IF EXISTS `cidades`;
CREATE DATABASE IF NOT EXISTS `cidades` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */;
USE `cidades`;

-- Copiando estrutura para tabela cidades.cidade
...
-- Copiando dados para a tabela cidades.cidade: 5.595 rows
...
-- Copiando estrutura para tabela cidades.estado
...
-- Copiando dados para a tabela cidades.estado: 28 rows
